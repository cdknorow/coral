...
// from the launch at which Coral first delivered a result. Coral is restarted
// often during normal use, so this is deliberately long: a reminder that
// arrives every few restarts reads as nagging rather than asking.
const nagInterval = 25
