...
| [Agent List Compact Overview](AGENT_LIST_COMPACT.md) | Proposed | Two-line 36–40px agent rows (dot + identity, one goal line), name+count group headers; context %, branch, tokens and elapsed time move to tooltip, workspace header and a team-details popover |
