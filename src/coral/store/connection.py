...
class DatabaseManager:
    ...
    async def _ensure_schema(self, conn: aiosqlite.Connection) -> None:
        ...
        _add_columns = [
            ...
            ("live_sessions", "subgent_key_id", "TEXT"),
            ("live_sessions", "subgent_api_key", "TEXT"),
            ("live_sessions", "subgent_admin_url", "TEXT"),
            ("live_sessions", "subgent_admin_key", "TEXT"),
            ("live_sessions", "subgent_org_id", "TEXT"),
            ("live_sessions", "subgent_board_id", "TEXT"),
